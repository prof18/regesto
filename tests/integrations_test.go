...
func TestIntegrationProfileValidationErrorsAreActionable(t *testing.T) {
	...
	for _, tc := range []struct{ name, file, body, want string }{
		...
		{"hermes-settings", "bad", `{"schema_version":1,"id":"bad","display_name":"Bad","skills":{"targets":[]},"instructions":{"targets":[]},"hooks":[{"protocol":"hermes-pre-llm-v1","registrar":"hermes-config-yaml-v1"}],"memory":[{"kind":"none"}],"default_trust":"quarantine"}`, "requires hermes-pre-llm-v1 and settings"},
