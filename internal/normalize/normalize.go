...
func Prompt(c Capture, vocabulary []string, existingIDs []string, projects ...string) string {
	...
	b.WriteString("  corrections given twice, non-obvious environment facts, preferences.\n")
	b.WriteString("- Do NOT record: anything derivable from reading the code, transient state\n")
	b.WriteString("  (branch names, in-flight work), or restatements of official documentation.\n")
